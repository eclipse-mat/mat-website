<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	<div id="midcolumn">
		<p>The Eclipse Memory Analyzer is a fast and feature-rich heap analyzer that helps you
		...
		<p>Using this features, a report automatically extracts leak suspects. It includes details about
		...
		The Wiki details <a href="http://wiki.eclipse.org/index.php/MemoryAnalyzer">how to get an heap dump</a>.
	</div>
	...
	<div id="rightcolumn">
 		...
 		<div class="sideitem">
			...
			<div align="left">Want to see the Memory Analyzer live and in action? Visit our EclipseCon session
		...
		<div class="sideitem">
			<h6>Newsgroup</h6>
			<div align="left">Got questions? Need advice? Miss a feature?
